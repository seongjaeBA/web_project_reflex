...
const data_grid_render_js_1 = require("./data-grid-render.js");
...
const DataGrid = (p, forwardedRef) => {
    ...
    const groupHeaderActionForEvent = React.useCallback((group, bounds, localEventX, localEventY) => {
        ...
        if (groupDesc.actions !== undefined) {
            const boxes = (0, data_grid_render_js_1.getActionBoundsForGroup)(bounds, groupDesc.actions);
            for (const [i, box] of boxes.entries()) {
                if ((0, data_grid_render_js_1.pointInRect)(box, localEventX + bounds.x, localEventY + box.y)) {
    ...
    const isOverHeaderMenu = React.useCallback((canvas, col, clientX, clientY) => {
        ...
        if (!isDragging && !isResizing && header.hasMenu === true && !(hoveredOnEdge ?? false)) {
            ...
            const menuBounds = (0, data_grid_render_js_1.getHeaderMenuBounds)(headerBounds.x, headerBounds.y, headerBounds.width, headerBounds.height, (0, utils_js_1.direction)(header.title) === "rtl");
                ...
                if (row !== undefined) {
                    ...
                    if (ctx !== null) {
                        ...
                        if (row === -1) {
                            ...
                            (0, data_grid_render_js_1.drawHeader)(ctx, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, mappedColumns[col], false, theme, false, false, 0, spriteManager, drawHeaderCallback, false);
                        }
                        else {
                            ctx.font = theme.baseFontFull;
                            ctx.fillStyle = theme.bgCell;
                            ctx.fillRect(0, 0, offscreen.width, offscreen.height);
                            (0, data_grid_render_js_1.drawCell)(ctx, getCellContent([col, row]), 0, row, false, false, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, false, theme, theme.bgCell, imageLoader, spriteManager, 1, undefined, false, 0, undefined, undefined, undefined, renderStateProvider, getCellRenderer, () => undefined);
                        }
                    }
