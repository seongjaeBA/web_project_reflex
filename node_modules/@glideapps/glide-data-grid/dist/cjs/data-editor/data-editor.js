...
const DataEditorImpl = (p, forwardedRef) => {
            ...
            if (forceStrict || experimental?.strict === true) {
                ...
                if (vr.extras?.freezeRegions !== undefined) {
                    for (const fr of vr.extras.freezeRegions) {
                        if ((0, data_grid_render_js_1.pointInRect)(fr, outerCol, row)) {
                            isInFreezeArea = true;
                            break;
                        }
                    }
    ...
    return (React.createElement(styles_js_1.ThemeContext.Provider, { value: mergedTheme },
        React.createElement(data_grid_container_js_1.DataEditorContainer, { style: (0, styles_js_1.makeCSSStyle)(mergedTheme), className: className, inWidth: width ?? idealWidth, inHeight: height ?? idealHeight },
