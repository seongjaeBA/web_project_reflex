...
import { isGroupEqual, itemsAreEqual, itemIsInRect, gridSelectionHasItem, getFreezeTrailingHeight, } from "../internal/data-grid/data-grid-lib.js";
...
const DataEditorImpl = (p, forwardedRef) => {
    ...
    return (React.createElement(ThemeContext.Provider, { value: mergedTheme },
        React.createElement(DataEditorContainer, { style: makeCSSStyle(mergedTheme), className: className, inWidth: width ?? idealWidth, inHeight: height ?? idealHeight },
